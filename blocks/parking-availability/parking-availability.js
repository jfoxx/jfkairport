(function cityForm() {
  ...
  .then(json => {
    ...
    t4Icon.innerHTML = `<span class="tIcon ${json[4].color}">4</span>`;
    ...
    t5Icon.innerHTML = `<span class="tIcon ${json[1].color}">5</span>`;
    ...
    t7Icon.innerHTML = `<span class="tIcon ${json[2].color}">7</span>`;
    ...
    t8Icon.innerHTML = `<span class="tIcon ${json[0].color}">8</span>`;
